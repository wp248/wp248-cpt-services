...
class wp248_cpt_services {
	...
	public function __construct() {
		...
		$this->plugin_name = 'wp248-cpt-services';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp248-cpt-services-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp248-cpt-services-i18n.php';
